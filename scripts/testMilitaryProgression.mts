...
assert.match(tools, /function createProceduralCrossbow/);
assert.match(tools, /function createProceduralSidearm/);
assert.match(tools, /function createProceduralSwordShield/);
assert.match(tools, /function createProceduralHalberd/);
assert.match(tools, /function createProceduralBow/);
