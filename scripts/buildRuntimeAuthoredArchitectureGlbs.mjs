...
const jobs = [
  ...
  },
  {
    ...
    output: path.join(outputDirectory, 'tier1_church_delnice_v2.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
    ...
    output: path.join(outputDirectory, 'hunters_camp_textured_v10.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
  ...
  },
  {
    ...
    output: path.join(outputDirectory, 'wayside_shrine_textured_v1.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
    ...
    output: path.join(outputDirectory, 'lumber_mill_textured_v1.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
    ...
    output: path.join(outputDirectory, 'mining_camp_textured_v1.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
    ...
    output: path.join(outputDirectory, 'large_quarry_textured_v1.glb'),
  },
  {
    source: path.join(
      repositoryRoot,
    ...
    output: path.join(outputDirectory, 'mineworks_textured_v1.glb'),
  },
];
