...
approx(sabbathWeek.capacityDaysPerWeek, sabbathProductiveShare * 7);
for (const key of [
  'flourOutputPerDay',
  ...
  approx(
    sabbathWeek[key],
    fullWeek[key] * sabbathProductiveShare / ordinaryProductiveShare,
  );
}
approx(
...
inactiveState.buildings.set('unstaffed-bakery', building('unstaffed-bakery', 'bakery', 0));
...
const splitBakery = building('split-bakery', 'bakery', 1);
splitBakery.x = 100;
...
const roadBakery = building('road-grain-bakery', 'bakery', 1);
roadBakery.x = 0;
