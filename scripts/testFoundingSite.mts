...
assert.match(settlementHud, />Treasury</);
assert.doesNotMatch(settlementHud, /settlement-hud__label">Treasury/);
assert.doesNotMatch(settlementHud, /Activate to locate physical holdings/);
