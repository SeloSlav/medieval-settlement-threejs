...
assert.match(visuals, /livestockHerdFormationOffsetMeters/);
assert.match(visuals, /formationTargetUv/);
assert.match(visuals, /pastureGateWaypoints/);
assert.match(visuals, /livestockWorkService/);
assert.match(visuals, /isStaffedHusbandryBuilding/);
assert.match(visuals, /lastShearingYear/);
assert.match(visuals, /lastMilkingPeriod/);
assert.match(visuals, /lastCulled/);
