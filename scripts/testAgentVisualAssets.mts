...
const cargoSignatures: Record<DeliveryCargoKind, string> = {
  ...
  sidearms: 'Polearm shaft 1',
  shields: 'Timber pole 1',
  bows: 'Polearm shaft 1',
  crossbows: 'Polearm shaft 1',
  paddedArmor: 'Woven cloth roll 1',
  mailArmor: 'Woven cloth roll 1',
  ammunition: 'Polearm shaft 1',
