...
requireNamed(bowyer, 'Bowyer target left splayed support');
requireNamed(bowyer, 'Bowyer target right splayed support');
requireNamed(bowyer, 'Bowyer target supporting header');
