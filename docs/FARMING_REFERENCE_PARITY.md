...
| Livestock needs and reproduction | Herd management constrains productive stocking | One farmstead cadence apportions shared labor, prepared feed, and trough water across its parcel herds, while grass/mast and cattle/sheep hay remain local. Each healthy, 90%-supplied group of at least two conceives by productive herd size—cattle in summer, sheep and woodland swine in autumn—and produces its confirmed offspring in spring, bounded by its local land cap and shared hub ceiling | Different by design — explicit local forage, shared husbandry inputs, and seasonal conception-to-birth cohorts |
