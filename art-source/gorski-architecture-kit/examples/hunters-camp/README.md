...
The v9 gameplay asset is authored at 3,000-4,000 triangles. It retains the v8 silhouettes and fixed component inventory while adding an explicit runtime material contract: building-atlas UVs are marked as final, timber tint and normal strengths survive GLB export, and the dedicated canvas/hide maps carry their warm weathered surface tints. Texture normal maps retain the small surface detail; automatic decimation is not used.
...
```powershell
& 'C:\Program Files\Blender Foundation\Blender 5.1\blender.exe' --background '.\out\hunters_camp_textured_v9.blend' --python-exit-code 1 --python '.\validate_hunters_camp.py'
...
- `out/hunters_camp_textured_v9.blend`
- `out/hunters_camp_textured_v9.glb`
- `out/hunters_camp_assembly_v9.json`
- `out/hunters_camp_validation_v9.json`
- `out/hunters_camp_roundtrip_validation_v9.json`
- `renders/hunters_camp_hero_v9.png`
- `renders/hunters_camp_overhead_v9.png`
- `renders/hunters_camp_workside_v9.png`
- `renders/hunters_camp_tent_detail_v9.png`
- `renders/hunters_camp_hide_shelter_detail_v9.png`
- `renders/hunters_camp_tools_detail_v9.png`
- `renders/hunters_camp_chopping_block_detail_v9.png`
