...
- `out/fishing_camp_textured_v5.blend` is the editable authored scene.
- `out/fishing_camp_textured_v5.glb` is the embedded-texture source delivery.
- Runtime compaction externalizes the already resident shared building atlas into `public/assets/models/buildings/gorski/fishing_camp_textured_v5.glb`.
