...
BUILDING_COVERAGE = {
    ...
    "wayside_shrine": _entry(
        ...
        "foundation_steps_limestone_1", "civic_shrine_side_rail_2m",
    ),
...
SUPPLEMENTAL_COVERAGE = {
    ...
    "residence_tier_2": _entry("housing", "Canonical limewashed Gorski house with split-shingle construction, proper ridge/eave/verge junctions, covered dormer, chimney flashing, and persistent controlled repair variants.", DOMESTIC, "roof_shingle_eave_edge_4m", "roof_shingle_verge_edge_full", "roof_shingle_ridge_endcap", "roof_shingle_repair_patch_1m", "roof_dormer_frame_2m", "roof_shingle_dormer_cap_1p2m", "roof_shingle_chimney_flashing", "production_chimney_limestone_h4m"),
    "residence_tier_3": _entry("housing", "Wider prosperous residence gains an annex/balcony and a complete laid-clay-tile roof vocabulary rather than a recolored shingle slab.", DOMESTIC, "roof_tile_panel_4m_full", "roof_tile_ridge_4m", "roof_tile_eave_edge_4m", "roof_tile_verge_edge_full", "roof_tile_ridge_endcap", "roof_tile_repair_patch_1m", "roof_tile_chimney_flashing", "roof_tile_dormer_cap_1p2m", "frame_balcony_4m", "frame_lean_to_4m"),
