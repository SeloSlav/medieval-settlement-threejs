...
SHEETS = {
    ...
    "openings": [
        "opening_window_tiny_plain", "opening_window_small_shuttered", "opening_window_domestic_plain", "opening_window_domestic_shuttered",
        "opening_window_shop_plain", "opening_louver_plain", "opening_window_lancet_stone", "opening_door_service_single",
        "opening_door_house_single", "opening_door_barn_double", "opening_door_barn_open-double", "opening_gate_cart_double",
        "opening_stable_half_door", "opening_church_arch_door", "opening_barn_loft_hatch", "opening_cellar_vent",
    ],
    "roofs": [
        ...
        "roof_timber_eave_4m", "roof_timber_valley_4m", "roof_dormer_frame_2m", "roof_snow_catch_2m",
    ],
    "enclosures": [
    ...
    "civic": [
        ...
        "civic_chapel_apse_halfround", "civic_shrine_canopy", "civic_shrine_niche_stone", "civic_processional_cross",
