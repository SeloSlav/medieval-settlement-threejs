...
export const CHAPEL_COFFER_CAPACITY = 600;
export const CHAPEL_TIER1_COFFER_CAPACITY = 240;
export const CHAPEL_TIER3_COFFER_CAPACITY = 1200;
export const CHAPEL_TIER1_TITHE_MULTIPLIER = 1;
export const CHAPEL_TIER2_TITHE_MULTIPLIER = 1.15;
export const CHAPEL_TIER3_TITHE_MULTIPLIER = 1.3;
export const CHAPEL_TIER2_UPGRADE_TIMBER = 32;
export const CHAPEL_TIER2_UPGRADE_STONE = 96;
export const CHAPEL_TIER2_UPGRADE_IRONWORK = 8;
export const CHAPEL_TIER2_UPGRADE_ROOF_TILES = 48;
export const CHAPEL_TIER2_UPGRADE_DRESSED_STONE = 0;
export const CHAPEL_TIER3_UPGRADE_TIMBER = 64;
export const CHAPEL_TIER3_UPGRADE_STONE = 144;
export const CHAPEL_TIER3_UPGRADE_IRONWORK = 24;
export const CHAPEL_TIER3_UPGRADE_ROOF_TILES = 112;
export const CHAPEL_TIER3_UPGRADE_DRESSED_STONE = 64;
export const CHAPEL_TIER4_COFFER_CAPACITY = 2400;
export const CHAPEL_TIER4_TITHE_MULTIPLIER = 1.5;
export const CHAPEL_TIER4_UPGRADE_TIMBER = 160;
export const CHAPEL_TIER4_UPGRADE_STONE = 432;
export const CHAPEL_TIER4_UPGRADE_IRONWORK = 80;
export const CHAPEL_TIER4_UPGRADE_ROOF_TILES = 320;
export const CHAPEL_TIER4_UPGRADE_DRESSED_STONE = 240;
export const CHAPEL_TIER2_UPKEEP_MULTIPLIER = 1.5;
export const CHAPEL_TIER3_UPKEEP_MULTIPLIER = 2.5;
export const CHAPEL_TIER4_UPKEEP_MULTIPLIER = 5;
export const CATHEDRAL_BISHOP_SETTLEMENT_TICKS_MULTIPLIER = 0.75;
...
export const MASON_STONE_PER_CYCLE = 8;
export const MASON_DRESSED_STONE_PER_CYCLE = 4;
...
export const FARM_REGIONAL_CORE_RADIUS_RATIO = 0.5;
export const FARM_REGIONAL_ASPECT_RATIO = 1.55;
...
export const BUILDING_COSTS = {
  ...
  stone_mason: { timber: 40, stone: 24, ironwork: 4 },
  ...
  monastery: { timber: 90, stone: 102, roofTiles: 72, dressedStone: 48 },
...
export const BUILDING_STORAGE_CAPS = {
  ...
  stone_mason: { timber: 0, firewood: 0, stone: 96, total: 160, dressedStone: 64 },
  ...
  village_storehouse: { timber: 2500, firewood: 2500, stone: 2500, total: 2500, wax: 2500, candles: 2500, wool: 2500, yarn: 2500, linen: 2500, cloth: 2500, pelts: 2500, ironwork: 2500, polearms: 2500, sidearms: 2500, shields: 2500, bows: 2500, crossbows: 2500, paddedArmor: 2500, mailArmor: 2500, ammunition: 2500, iron: 2500, clay: 2500, salt: 2500, charcoal: 2500, pottery: 2500, hides: 2500, leather: 2500, shoes: 2500, dressedStone: 2500, remedies: 2500 },
...
export const TRADE_RESOURCE_KINDS = ["timber","stone","firewood","water","ryeGrain","oatGrain","maslinGrain","ryeFlour","maslinFlour","ryeBread","maslinBread","ale","cider","honey","wax","candles","wine","ironwork","polearms","sidearms","shields","bows","crossbows","paddedArmor","mailArmor","ammunition","wool","cloth","pelts","hides","leather","shoes","barley","malt","flax","iron","clay","salt","charcoal","pottery","manure","remedies","roofTiles","dressedStone","meat","fish","berries","mushrooms","milk","apples","pears","cherries","aronia","rosehips","cabbage","carrots","beetroot","eggs","grapes","curedMeat","smokedFish","cheese","jam","ryeSheaves","oatSheaves","barleySheaves","maslinSheaves","yarn","linen"] as const;
...
export const MARKETPLACE_TRADE_OFFERS = [
  ...
  {"id":"buy_dressed_stone","kind":"goldBuy","resource":"dressedStone","amount":12,"goldCost":48},
