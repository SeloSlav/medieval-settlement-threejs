...
export default __t.row({
  ...
  dressedStone: __t.f64().name("dressed_stone"),
  ...
  constructionRequiredDressedStone: __t.f64().name("construction_required_dressed_stone"),
  constructionDeliveredRoofTiles: __t.f64().name("construction_delivered_roof_tiles"),
  constructionDeliveredDressedStone: __t.f64().name("construction_delivered_dressed_stone"),
  constructionReservedRoofTiles: __t.f64().name("construction_reserved_roof_tiles"),
  constructionReservedDressedStone: __t.f64().name("construction_reserved_dressed_stone"),
  constructionTreasuryRoofTiles: __t.f64().name("construction_treasury_roof_tiles"),
  constructionTreasuryDressedStone: __t.f64().name("construction_treasury_dressed_stone"),
  cider: __t.f64(),
  mead: __t.f64(),
