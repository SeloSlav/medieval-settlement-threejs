...
const DETAILS: Record<PlacementArtKey, BuildCardDetail> = {
  ...
  brewery: ['Brewhouse', 'Malts barley for ale, makes apple or pear cider, and ferments honey into mead.', flow(['barley', 'apples', 'pears', 'honey', 'water', 'firewood'], ['ale', 'cider', 'pearCider', 'mead'])],
  ...
  chandlery: ['Chandlery', 'Makes beeswax candles for households, church services, and trade.', flow(['wax', 'firewood'], ['candles'])],
