...
const DETAILS: Record<PlacementArtKey, BuildCardDetail> = {
  ...
  threshing_barn: ['Farmstead', 'T', 'Harvests and threshes rye, oats, barley, maslin, and flax. Threshed oats are ready food and premium livestock fodder; they need no mill or bakery.', flow(['ryeSheaves', 'oatSheaves', 'barleySheaves', 'maslinSheaves'], ['ryeGrain', 'oatGrain', 'barley', 'maslinGrain', 'flax'])],
  watermill: ['Grain watermill', 'M', 'Grinds rye or maslin into matching flour with seasonal river power. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'maslinGrain'], ['ryeFlour', 'maslinFlour'])],
  windmill: ['Grain windmill', 'I', 'Grinds rye or maslin into matching flour wherever wind is strong. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'maslinGrain'], ['ryeFlour', 'maslinFlour'])],
