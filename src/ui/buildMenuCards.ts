...
const DETAILS: Record<PlacementArtKey, BuildCardDetail> = {
  ...
  watermill: ['Grain watermill', 'M', 'Grinds grain into flour with seasonal river power. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'oatGrain', 'maslinGrain'], ['ryeFlour', 'oatFlour', 'maslinFlour'])],
  windmill: ['Grain windmill', 'I', 'Grinds grain into flour wherever wind is strong. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'oatGrain', 'maslinGrain'], ['ryeFlour', 'oatFlour', 'maslinFlour'])],
