...
const DETAILS: Record<PlacementArtKey, BuildCardDetail> = {
  ...
  brewery: ['Brewhouse', 'Malts barley for ale, makes apple or pear cider, and ferments honey into mead.', flow(['barley', 'apples', 'pears', 'honey', 'water', 'firewood'], ['ale', 'cider', 'cider', 'mead'])],
