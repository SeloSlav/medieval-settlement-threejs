...
const DETAILS: Record<PlacementArtKey, BuildCardDetail> = {
  ...
  monastery: ['Pauline monastery', 'O', 'A walled edge estate with player-selected orchard and croft plantings. Its own pantry serves the infirmary and feasts; genuine surplus is sold beyond the map for private revenue.', flow([], ['ale', 'cider', 'wine', 'honey', 'gold'])],
  ...
  threshing_barn: ['Farmstead', 'T', 'Harvests and threshes rye, oats, barley, maslin, and flax; oats are ready food and livestock fodder.', flow(['ryeSheaves', 'oatSheaves', 'barleySheaves', 'maslinSheaves'], ['ryeGrain', 'oatGrain', 'barley', 'maslinGrain', 'flax'])],
  watermill: ['Grain watermill', 'M', 'Grinds rye and maslin grain into flour with seasonal river power. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'maslinGrain'], ['ryeFlour', 'maslinFlour'])],
  windmill: ['Grain windmill', 'I', 'Grinds rye and maslin grain into flour wherever wind is strong. Smith-dressed millstones and maintained iron fittings raise output.', flow(['ryeGrain', 'maslinGrain'], ['ryeFlour', 'maslinFlour'])],
  granary: ['Village granary', 'N', 'Collects and distributes food; it does not process it.'],
  bakery: ['Village bakery', 'B', 'Bakes rye or maslin flour into matching bread.', flow(['ryeFlour', 'maslinFlour', 'water', 'firewood'], ['ryeBread', 'maslinBread'])],
