...
export const HERALDRY_TINCTURES = [
  { id: 'gules', name: 'Red', value: HERALDRY_CLOTH_COLORS.red,
    dye: 'Madder red', description: 'Madder root dyes wool a warm, strong red.' },
  { id: 'azure', name: 'Blue', value: HERALDRY_CLOTH_COLORS.blue,
    dye: 'Woad blue', description: 'Woad vat-dyeing produces blue cloth.' },
  ...
  { id: 'sable', name: 'Black', value: HERALDRY_CLOTH_COLORS.black,
    dye: 'Tannin black', description: 'Oak-gall tannins and iron salts produce black.' },
  { id: 'purpure', name: 'Purple', value: HERALDRY_CLOTH_COLORS.purple,
    dye: 'Madder and woad purple', description: 'Madder red and woad blue produce a subdued purple.' },
  { id: 'argent', name: 'White', value: HERALDRY_CLOTH_COLORS.white,
    dye: 'Wool white · Argent', description: 'Light, undyed wool gives a warm off-white.' },
  { id: 'or', name: 'Yellow', value: HERALDRY_CLOTH_COLORS.yellow,
    dye: 'Weld yellow · Or', description: 'Weld flowers and leaves produce yellow.' },
  { id: 'crimson', name: 'Crimson', value: HERALDRY_CLOTH_COLORS.crimson,
    dye: 'Kermes crimson', description: 'Kermes insects provide a rich red dye.' },
  { id: 'russet', name: 'Russet', value: HERALDRY_CLOTH_COLORS.russet,
    dye: 'Madder russet', description: 'Madder dyes produce a warm orange-brown.' },
