...
export const TRADE_RESOURCE_LABELS: Record<TradeResourceKind, string> = {
  ...
  curedMeat: 'Cured meat', smokedFish: 'Smoked fish',
  cheese: 'Cheese', jam: 'Jam', honey: 'Honey', wax: 'Beeswax', candles: 'Candles',
...
export const TRADING_POST_TRADE_CATEGORIES = [
  ...
  { label: 'Savory preserves', resources: ['curedMeat', 'smokedFish', 'cheese'] },
  { label: 'Sweet preserves', resources: ['honey', 'jam'] },
  { label: 'Textiles & wares', resources: ['ale', 'cider', 'wine', 'wool', 'yarn', 'linen', 'cloth', 'pelts', 'hides', 'leather', 'shoes', 'wax', 'candles', 'pottery', 'remedies'] },
