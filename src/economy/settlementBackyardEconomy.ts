...
function emptyKindPlans(): Record<BackyardGardenKind, BackyardGardenKindPlan> {
  return {
    ...
    cabbage_garden: emptyKindPlan(),
    carrot_garden: emptyKindPlan(),
    beetroot_garden: emptyKindPlan(),
    flower_garden: emptyKindPlan(),
    herb_garden: emptyKindPlan(),
    animal_pen: emptyKindPlan(),
    chicken_pen: emptyKindPlan(),
    goat_pen: emptyKindPlan(),
    pig_pen: emptyKindPlan(),
