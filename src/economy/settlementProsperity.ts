...
const PER_RESIDENT_PER_DAY: Record<ProsperityCommodity, number> = {
  savoryPreserves:
    ...
    * CALENDAR_SECONDS_PER_DAY
    * RESIDENCE_PRESERVED_FOOD_WINTER_MULTIPLIER,
  ale: RESIDENCE_ALE_PER_PERSON_PER_SEC * CALENDAR_SECONDS_PER_DAY,
  cloth: RESIDENCE_CLOTH_PER_PERSON_PER_SEC * CALENDAR_SECONDS_PER_DAY,
  shoes: RESIDENCE_SHOES_PER_PERSON_PER_SEC * CALENDAR_SECONDS_PER_DAY,
  pottery: RESIDENCE_POTTERY_PER_PERSON_PER_SEC * CALENDAR_SECONDS_PER_DAY,
};
