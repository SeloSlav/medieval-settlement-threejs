...
const right:Record<GripKind,readonly [Fit,Fit]>={
  ...
  halberd:[
    fit([[.45,.15],[.3,1.8],[.45,1.65],[.45,1.8]],[0,-.2,0]),
    fit([[.15,1.05],[.75,.75],[.3,1.95],[.6,.15]],[0,-1.2,.4]),
  ],
  sidearm:[
    fit([[.9,1.5],[1.05,1.05],[1.35,.15],[.75,1.95]],[0,-.6,-.6]),
    fit([[.75,.15],[.6,1.95],[1.2,.45],[1.5,1.5]],[0,-1.4,.4]),
  ],
  'sword-shield':[
    fit([[.75,.9],[1.05,.6],[.45,1.8],[.75,1.5]],[0,-1.4,-.6]),
    fit([[.6,1.05],[.3,1.95],[.9,1.05],[1.5,1.65]],[0,-1.4,.4]),
  ],
  dagger:[
...
const support:Record<'spear'|'pike-kit'|'halberd',readonly [Fit,Fit]>={
  ...
  halberd:[
    fit([[.3,1.35],[.45,.9],[.45,1.35],[1.05,.3]],[0,-1,-.8],true),
    fit([[.3,1.8],[.9,.75],[1.2,.45],[1.2,.9]],[0,-.2,0],true),
  ],
};
