// Frozen pre-gauntlet profile values. Imported only by the QA baseline.
...
export const WATER_BASELINE_PROFILES = {river:RIVER_WATER_PROFILE,inland:INLAND_WATER_PROFILE,coastal:COASTAL_WATER_PROFILE};
