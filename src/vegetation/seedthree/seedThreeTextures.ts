...
const barkModules = import.meta.glob(
  '../../../vendor/seedthree/assets/bark/{american_beech,white_oak,red_maple,sweetgum,douglas_fir,loblolly,pine,apple_bark,cherry_bark,bilberry_branch,common_juniper_branch,raspberry_cane,hornbeam_hedge_branch}_{albedo,normal,roughness}.png',
  {
    eager: true,
    query: '?url',
    import: 'default',
...
const leafModules = import.meta.glob(
  [
    ...
    '../../../vendor/seedthree/assets/leaves/{bilberry,fern,juniper_scrub,raspberry_spray,hornbeam_hedge_spray}_{albedo,normal,roughness,translucency}.png',
