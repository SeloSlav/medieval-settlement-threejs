...
function buildingStateFromRow(
  ...
  return {
    ...
    water: row.water,
    food: row.food,
    ryeSheaves: row.ryeSheaves,
    oatSheaves: row.oatSheaves,
    barleySheaves: row.barleySheaves,
    maslinSheaves: row.maslinSheaves,
    ryeGrain: row.ryeGrain,
    oatGrain: row.oatGrain,
    maslinGrain: row.maslinGrain,
    barley: row.barley,
    malt: row.malt,
    flax: row.flax,
    ryeFlour: row.ryeFlour,
    oatFlour: row.oatFlour,
    maslinFlour: row.maslinFlour,
    ale: row.ale,
