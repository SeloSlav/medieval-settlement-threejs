...
export function syncPlayerResources(rows: Iterable<PlayerResources>, state: GameTableSyncState): void {
  ...
  for (const row of rows) {
    ...
    state.stockpile = {
      ...
      fish: row.fish ?? 0,
      food: row.food ?? 0,
      ryeSheaves: row.ryeSheaves ?? 0,
      oatSheaves: row.oatSheaves ?? 0,
      barleySheaves: row.barleySheaves ?? 0,
      maslinSheaves: row.maslinSheaves ?? 0,
      ryeGrain: row.ryeGrain ?? 0,
      oatGrain: row.oatGrain ?? 0,
      maslinGrain: row.maslinGrain ?? 0,
      barley: row.barley ?? 0,
      malt: row.malt ?? 0,
      flax: row.flax ?? 0,
      ryeFlour: row.ryeFlour ?? 0,
      oatFlour: row.oatFlour ?? 0,
      maslinFlour: row.maslinFlour ?? 0,
      ale: row.ale ?? 0,
      ...
      ryeBread: row.ryeBread ?? 0,
      oatBread: row.oatBread ?? 0,
      maslinBread: row.maslinBread ?? 0,
      meat: row.meat ?? 0,
      milk: row.milk ?? 0,
      apples: row.apples ?? 0,
