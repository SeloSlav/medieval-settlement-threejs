...
export const PROCEDURAL_BUILDING_CATALOG = {
  ...
  cavalry_yard: { ...commonRural, family: 'defensive', status: 'major', massing: ['six-bay-stable-wing', 'fenced-training-paddock', 'feed-and-tack-store'], modules: [...commonRural.modules, 'loose-box-stalls', 'schooling-track', 'covered-hitching-rail', 'feed-store'], materials: [...commonRural.materials, 'packed-earth', 'wrought-iron'], dynamicSlots: ['horse-roster', 'training-progress', 'fodder-stock', 'mounted-companies'], triangleTarget: 9_000, triangleCeiling: 18_000, historicalNote: 'A compact frontier remount depot and training yard for Croatian-Hungarian light horse, armored lancers, and mounted archers.' },
