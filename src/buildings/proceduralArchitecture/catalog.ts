...
export const PROCEDURAL_BUILDING_CATALOG = {
  ...
  lumber_mill: { ...commonWorkshop, family: 'forestry', status: 'major', massing: ['open-saw-shed', 'log-intake-yard'], modules: [...commonWorkshop.modules, 'saw-frame', 'log-ways'], triangleTarget: 7_500, triangleCeiling: 14_000, historicalNote: 'Water-independent hand-saw yard with a roofed working bay and open timber intake.' },
  ...
  woodcutters_lodge: { ...commonRural, family: 'forestry', status: 'standard', massing: ['low-woodland-lodge', 'covered-cutting-bay'], modules: [...commonRural.modules, 'cutting-lean-to'], dynamicSlots: ['firewood', 'timber-stock'] },
  stone_quarry: {
    ...
    materials: ['packed-earth', 'fieldstone', 'rough-timber', 'wrought-iron'], dynamicSlots: ['ore-stock', 'support-stock'],
  ...
  large_quarry: {
    ...
    materials: ['packed-earth', 'fieldstone', 'rough-timber', 'split-shingles', 'wrought-iron'], dynamicSlots: ['stone-stock', 'support-stock'],
  ...
  mine: {
    ...
    materials: ['packed-earth', 'fieldstone', 'rough-timber', 'split-shingles', 'wrought-iron'], dynamicSlots: ['ore-stock', 'support-stock'],
  ...
  charcoal_burner: { ...commonWorkshop, family: 'craft', status: 'site', roof: 'open-workyard', massing: ['charcoal-clamp-yard', 'small-weather-shelter'], modules: ['charcoal-clamp', 'earth-cover', 'tool-shelter'], materials: ['packed-earth', 'rough-timber', 'split-shingles'], dynamicSlots: ['firewood', 'charcoal-stock', 'clamp-smoke'], triangleTarget: 3_200, triangleCeiling: 7_000 },
  ...
  bowyer_fletcher: { ...commonWorkshop, family: 'craft', status: 'standard', modules: [...commonWorkshop.modules, 'seasoning-rack', 'long-workbench'], dynamicSlots: ['timber-stock', 'ironwork-stock', 'finished-arms'] },
  potter_kiln: { ...commonWorkshop, family: 'craft', status: 'standard', roof: 'industrial-hood', massing: ['open-potters-yard', 'domed-kiln', 'weather-shelter'], modules: ['domed-kiln', 'firebox', 'drying-shelves', 'lean-to'], materials: ['packed-earth', 'fieldstone', 'rough-timber', 'split-shingles'], dynamicSlots: ['clay-stock', 'firewood', 'pottery-stock'], historicalNote: 'A detached fired-clay kiln and open drying yard, not a clay extraction building.' },
  well: {
    family: 'service', status: 'small', roof: 'tower-cap', massing: ['stone-well-head', 'open-weather-cap'],
    modules: ['lined-well-ring', 'windlass', 'four-sided-shingle-cap'], materials: ['fieldstone', 'rough-timber', 'split-shingles', 'wrought-iron'], dynamicSlots: ['water-surface'],
  ...
  hunters_hall: {
    ...
    materials: ['packed-earth', 'linen-canvas', 'rough-timber', 'fieldstone', 'wicker'], dynamicSlots: ['food-stock', 'hearth-fire', 'smoke'],
  ...
  foragers_shed: { ...commonRural, family: 'service', status: 'small', massing: ['compact-gathering-shed', 'covered-sorting-porch'], modules: [...commonRural.modules, 'sorting-porch'], dynamicSlots: ['food-stock', 'remedy-stock'], historicalNote: 'Small woodland store and sorting porch; all living plants remain owned by SeedThree.' },
  fishing_camp: {
  ...
  chapel: {
    ...
    materials: ['fieldstone', 'lime-plaster', 'split-shingles', 'clay-tiles', 'wrought-iron'], dynamicSlots: ['clock', 'bell', 'devotional-light'],
  ...
  wayside_shrine: {
    ...
    modules: ['fieldstone-plinth', 'limewashed-niche', 'shingle-cap', 'simple-iron-cross'],
    materials: ['fieldstone', 'lime-plaster', 'split-shingles', 'wrought-iron'], dynamicSlots: ['devotional-candle'],
  ...
  marketplace: { ...commonRural, family: 'commerce', status: 'major', roof: 'canvas-fly', massing: ['open-market-lane', 'modular-covered-stalls'], modules: ['timber-stalls', 'canvas-awnings', 'central-access-lane'], materials: ['packed-earth', 'rough-timber', 'linen-canvas', 'wicker'], dynamicSlots: ['market-stock', 'stall-occupancy'], triangleTarget: 9_000, triangleCeiling: 18_000, drawCallTarget: 12, historicalNote: 'An open periodic market assembled from reversible timber stalls and cloth awnings.' },
  trading_post: { ...commonRural, family: 'commerce', status: 'major', massing: ['secure-roadside-store', 'covered-loading-bay'], modules: [...commonRural.modules, 'cart-portal', 'loading-canopy'], dynamicSlots: ['trade-stock', 'cart-stage'] },
  town_hall: { ...commonRural, family: 'civic', status: 'landmark', roof: 'cross-gable', massing: ['two-storey-civic-house', 'front-council-porch'], modules: [...commonRural.modules, 'stone-ground-storey', 'council-chamber', 'public-portal'], materials: ['fieldstone', 'limestone-ashlar', 'lime-plaster', 'rough-timber', 'clay-tiles', 'wrought-iron'], triangleTarget: 14_000, triangleCeiling: 28_000, drawCallTarget: 10, historicalNote: 'A prosperous but compact civic house, not a later baroque town hall.' },
  stable: { ...commonRural, family: 'civic', status: 'standard', massing: ['long-stable-range', 'covered-bays'], modules: [...commonRural.modules, 'wide-stall-doors', 'vented-loft', 'covered-tie-rail'], dynamicSlots: ['ox-slots', 'fodder-stock'] },
  ...
  watchtower: { ...commonRural, family: 'defensive', status: 'major', roof: 'tower-cap', massing: ['tall-timber-watch-platform', 'enclosed-ground-store'], modules: ['stone-footing', 'braced-tower-frame', 'covered-watch-platform'], materials: ['fieldstone', 'rough-timber', 'split-shingles', 'wrought-iron'], dynamicSlots: ['guards'], triangleTarget: 6_000, triangleCeiling: 12_000, drawCallTarget: 8, historicalNote: 'A compact frontier timber watch post with explicit diagonal bracing and a weather cap.' },
  guardhouse: { ...commonRural, family: 'defensive', status: 'standard', massing: ['roadside-guard-room', 'covered-muster-porch'], modules: [...commonRural.modules, 'muster-porch', 'arms-store'], dynamicSlots: ['food-stock', 'arms-stock', 'guards'] },
  palisaded_refuge: { ...commonRural, family: 'defensive', status: 'landmark', roof: 'tower-cap', massing: ['compact-palisaded-enclosure', 'gatehouse', 'refuge-shelters'], modules: ['palisade-circuit', 'defended-gate', 'watch-platform', 'interior-shelters'], materials: ['packed-earth', 'fieldstone', 'rough-timber', 'split-shingles', 'wrought-iron'], dynamicSlots: ['refuge-occupancy', 'guards'], triangleTarget: 18_000, triangleCeiling: 36_000, drawCallTarget: 12, historicalNote: 'A small timber refuge enclosure suited to a frontier settlement, not a masonry castle.' },
  threshing_barn: { ...commonRural, family: 'agricultural', status: 'major', massing: ['broad-ventilated-barn', 'central-threshing-floor'], modules: ['fieldstone-footing', 'boarded-barn-frame', 'opposed-cart-doors', 'split-shingle-roof'], materials: ['fieldstone', 'weathered-boards', 'rough-timber', 'split-shingles'], dynamicSlots: ['grain-stock'] },
  pastoral_farmstead: { ...commonRural, family: 'livestock', status: 'major', massing: ['farmhouse-range', 'attached-animal-shelter'], modules: [...commonRural.modules, 'stock-shelter', 'hay-bay'], dynamicSlots: ['animals', 'fodder', 'salt-stock'] },
  swineherd: { ...commonRural, family: 'livestock', status: 'standard', massing: ['small-herdsman-hut', 'open-pig-shelter'], modules: [...commonRural.modules, 'low-animal-shelter'], dynamicSlots: ['animals', 'fodder'] },
  monastery: { ...commonRural, family: 'religious', status: 'landmark', roof: 'cross-gable', massing: ['courtyard-monastic-precinct', 'chapel-range', 'guest-and-work-ranges'], modules: ['stone-cloister-ranges', 'chapel', 'service-courtyard', 'guesthouse'], materials: ['fieldstone', 'limestone-ashlar', 'lime-plaster', 'rough-timber', 'clay-tiles', 'wrought-iron'], dynamicSlots: ['food-stock', 'drink-stock', 'estate-extensions'], triangleTarget: 40_000, triangleCeiling: 110_000, drawCallTarget: 18, historicalNote: 'A compact regional religious estate assembled by ranges, without later monumental baroque language.' },
  ...
  tavern: { ...commonRural, family: 'commerce', status: 'major', massing: ['roadside-public-house', 'covered-entry-gallery'], modules: [...commonRural.modules, 'public-room', 'cellar-access', 'entry-gallery'], dynamicSlots: ['ale-stock', 'food-stock', 'patrons'], triangleTarget: 8_500, triangleCeiling: 16_000 },
  smokehouse: { ...commonWorkshop, family: 'food-processing', status: 'small', roof: 'industrial-hood', massing: ['sealed-smoking-house', 'service-lean-to'], modules: ['stone-firebox', 'boarded-smoking-chamber', 'vented-roof', 'service-lean-to'], materials: ['fieldstone', 'weathered-boards', 'rough-timber', 'split-shingles'], dynamicSlots: ['fresh-food', 'salt', 'firewood', 'preserved-food', 'smoke'], historicalNote: 'A compact detached smoking chamber whose fire and hanging goods remain runtime-owned.' },
  ...
  apiary: { ...commonRural, family: 'agricultural', status: 'site', roof: 'lean-to', massing: ['open-apiary-stand', 'small-processing-shelter'], modules: ['covered-hive-stand', 'processing-table', 'tool-chest'], materials: ['packed-earth', 'rough-timber', 'split-shingles', 'wicker'], dynamicSlots: ['honey-stock', 'bee-activity'], triangleTarget: 3_500, triangleCeiling: 7_500, historicalNote: 'Covered skeps and a small reversible work shelter; flowering vegetation remains owned by SeedThree.' },
  watermill: { ...commonWorkshop, family: 'food-processing', status: 'major', massing: ['streamside-mill-house', 'wheel-bay'], modules: [...commonWorkshop.modules, 'waterwheel', 'axle-house', 'mill-race-apron'], dynamicSlots: ['grain-stock', 'flour-stock', 'wheel'], triangleTarget: 10_000, triangleCeiling: 20_000 },
  ...
  carpenter: { ...commonWorkshop, family: 'craft', status: 'standard', massing: ['open-carpentry-shed', 'covered-bench-range'], modules: ['braced-open-frame', 'split-shingle-roof', 'workbenches', 'timber-rack'], materials: ['packed-earth', 'rough-timber', 'weathered-boards', 'split-shingles', 'wrought-iron'], dynamicSlots: ['timber-stock', 'ironwork-stock', 'finished-tools'] },
  spinning_retting_house: { ...commonWorkshop, family: 'textile', status: 'major', massing: ['dry-spinning-house', 'separate-wet-retting-bay'], modules: [...commonWorkshop.modules, 'wet-service-bay', 'vented-loft'], dynamicSlots: ['wool-stock', 'flax-stock', 'yarn-stock', 'linen-stock'] },
  weaver: { ...commonWorkshop, family: 'textile', status: 'standard', modules: [...commonWorkshop.modules, 'broad-lit-work-bay', 'cloth-drying-rail'], dynamicSlots: ['yarn-stock', 'linen-stock', 'cloth-stock'] },
  tannery: { ...commonWorkshop, family: 'craft', status: 'major', massing: ['open-wet-yard', 'covered-bark-and-hide-shed'], modules: ['tanning-vats', 'covered-working-bay', 'drying-frame', 'service-shed'], materials: ['packed-earth', 'fieldstone', 'rough-timber', 'split-shingles', 'wicker'], dynamicSlots: ['hide-stock', 'bark-stock', 'leather-stock'], historicalNote: 'A deliberately separated wet craft yard with open vats and a roofed dry-work bay.' },
  ...
  chandlery: { ...commonWorkshop, family: 'craft', status: 'standard', massing: ['compact-chandlers-shop', 'vented-melting-bay'], modules: [...commonWorkshop.modules, 'melt-hearth', 'vented-service-bay', 'cooling-racks'], dynamicSlots: ['wax-stock', 'wick-stock', 'candle-stock'] },
