...
function renderMaterialProcurementPolicy(
  ...
  return `
    <section class="marketplace-trade-section" aria-label="Workshop input procurement">
      ...
      <p class="resource-inspector-note">Set physical market stock for regionally sourced inputs. Each twelve-unit lot consumes broker time, coffer gold, and the current regional rate. Free market carts are matched settlement-wide to stage iron, salt, and uncommitted pottery working buffers at staffed road-linked smithies and smokehouses; paid household orders and seed recovery retain first claim, then work priority, cycle runway, road length, and stable order decide the next workshop and supplying market. Pottery promised to an active export order stays at the market. All standing imports share one queue and the most depleted selected reserve goes first.</p>
