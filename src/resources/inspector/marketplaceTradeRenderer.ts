  ...
  return `
    <div class="marketplace-trade-panel">
      ...
      <p class="marketplace-trade-intro">${physicalEconomy
        ...
        : 'Legacy saves may export treasury stock and goods in road-linked building stores directly; household provisions remain protected.'} Every non-currency commodity produced by the settlement has both a public bulk import and export contract. Ale, cloth, honey, wine, cheese, and pottery can also use the private automatic specialty desk after local reserves. Every paid import is carried from the map edge: public food and water lots unload here and continue on staffed broker carts to road-linked homes; raw materials and wares remain physically available for local collection. Named household and parish orders stay attached to their exact destination. Public contracts are civic treasury trade and therefore tax-neutral; Town Hall customs apply only to private household imports and automatic private exports.</p>
