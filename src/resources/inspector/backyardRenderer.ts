  ...
  return {
    ...
    detailsHtml: `
      ...
      ${BACKYARD_GARDEN_DEFINITIONS[garden.kind].jamPerPersonPerSec > 0
        ? `<li><span>Jam</span><span>${Math.max(0, residence.jam ?? 0).toFixed(1)} jars in the household pantry · household labor preserves this share of the harvested fruit rather than creating extra output · transferable sweet preserves for meals and trade</span></li>`
        : ''}
      ${producesFood
