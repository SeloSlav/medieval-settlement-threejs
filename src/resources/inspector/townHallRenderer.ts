...
export function renderTownHallInspector(
  ...
  return {
    ...
    detailsHtml: `
      ...
      <li><span>Pottery chain</span><span>${industrialMaterials.potteryOutputPerDay.toFixed(1)} road-supplied / ${industrialMaterials.potterInstalledOutputPerDay.toFixed(1)} installed pottery per day &middot; ${industrialMaterials.potteryCoveredDemandPerDay.toFixed(1)} / ${industrialMaterials.potteryDemandPerDay.toFixed(1)} household + smokehouse demand covered &middot; ${industrialMaterials.potteryExportSurplusPerDay.toFixed(1)} exportable and ${industrialMaterials.potteryStrandedPerDay.toFixed(1)} stranded surplus &middot; consumes ${industrialMaterials.potterClayPerDay.toFixed(1)} / ${industrialMaterials.clayOutputPerDay.toFixed(1)} clay capacity + ${industrialMaterials.potterFirewoodPerDay.toFixed(1)} firewood + ${industrialMaterials.potterWaterPerDay.toFixed(1)} puddling water/day from staffed same-branch wells</span></li>
      <li><span>Ironwork chain</span><span>${industrialMaterials.ironworkOutputPerDay.toFixed(1)} road-supplied / ${industrialMaterials.smithyInstalledIronworkPerDay.toFixed(1)} installed ironwork per day &middot; needs ${industrialMaterials.smithyIronPerDay.toFixed(1)} raw iron + ${industrialMaterials.smithyCharcoalPerDay.toFixed(1)} / ${industrialMaterials.charcoalOutputPerDay.toFixed(1)} charcoal capacity + ${industrialMaterials.smithyWaterPerDay.toFixed(1)} quench water from staffed same-branch wells &middot; same-branch mines sustain ${industrialMaterials.localIronConsumedPerDay.toFixed(1)} / ${industrialMaterials.localIronOutputPerDay.toFixed(1)} raw iron per day, leaving ${industrialMaterials.ironImportDemandPerDay.toFixed(1)} for market imports and ${industrialMaterials.localIronStrandedPerDay.toFixed(1)} locally stranded &middot; charcoal yards consume ${industrialMaterials.charcoalFirewoodPerDay.toFixed(1)} firewood/day</span></li>
