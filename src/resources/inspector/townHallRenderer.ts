...
export function renderTownHallInspector(
  ...
  return {
    ...
    detailsHtml: `
      ...
      <li><span>Ironwork chain</span><span>${industrialMaterials.ironworkOutputPerDay.toFixed(1)} road-supplied / ${industrialMaterials.smithyInstalledIronworkPerDay.toFixed(1)} installed ironwork per day &middot; needs ${industrialMaterials.smithyIronPerDay.toFixed(1)} raw iron + ${industrialMaterials.smithyCharcoalPerDay.toFixed(1)} / ${industrialMaterials.charcoalOutputPerDay.toFixed(1)} charcoal capacity &middot; same-branch mines sustain ${industrialMaterials.localIronConsumedPerDay.toFixed(1)} / ${industrialMaterials.localIronOutputPerDay.toFixed(1)} raw iron per day, leaving ${industrialMaterials.ironImportDemandPerDay.toFixed(1)} for market imports and ${industrialMaterials.localIronStrandedPerDay.toFixed(1)} locally stranded &middot; charcoal yards consume ${industrialMaterials.charcoalFirewoodPerDay.toFixed(1)} firewood/day</span></li>
