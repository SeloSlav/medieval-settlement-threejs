...
- Review candidate: `forest-leaf-litter-secondary`
- Approved: 2026-08-26
...
- Runtime normal: PATINA green channel flipped to match the project's existing
  ...
  `0.55`, then renormalized with a reconstructed
...
`artifacts/pbr-material-review/patina-candidates/forest-leaf-litter-secondary/`.
