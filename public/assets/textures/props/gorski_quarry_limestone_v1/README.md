...
- Review candidate: `clean-quarry-limestone-v2`
- Approved: 2026-08-26
...
- Runtime normal: PATINA green channel flipped to match the project's existing
  ...
  `0.66`, then renormalized with a reconstructed
...
`artifacts/pbr-material-review/patina-candidates/clean-quarry-limestone-v2/`.
