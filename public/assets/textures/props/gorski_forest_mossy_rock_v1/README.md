...
- Review candidate: `forest-mossy-karst-rock-v3`
- Approved: 2026-08-26
...
- Runtime normal: PATINA green channel flipped to match the project's existing
  ...
  `0.68`, then renormalized with a reconstructed
...
`artifacts/pbr-material-review/patina-candidates/forest-mossy-karst-rock-v3/`.
