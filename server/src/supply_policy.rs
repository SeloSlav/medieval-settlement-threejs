...
use crate::balance_generated::{
    ...
    CARPENTER_CART_SERVICE_TIMBER_PER_TRIP, CHANDLERY_FIREWOOD_PER_CYCLE, CHANDLERY_WAX_PER_CYCLE,
    CHARCOAL_BURNER_FIREWOOD_PER_CYCLE, CIVILIAN_TOOL_IRONWORK_PER_CYCLE,
    COBBLER_LEATHER_PER_CYCLE, HOUSEHOLD_FOOD_RESERVE_CAPACITY_FRACTION,
    ...
    LIVESTOCK_FEED_OAT_GRAIN_PER_CYCLE, MINE_TIMBER_SUPPORT_BUFFER_CYCLES,
...
pub fn directly_dispatched_processor_input_per_cycle(target_kind: &str, commodity: &str) -> f64 {
    let authored_cost = match (target_kind, commodity) {
        ...
        ("spinning_retting_house", "wool") => SPINNING_RETTING_WOOL_PER_CYCLE,
        ("spinning_retting_house", "flax") => SPINNING_RETTING_FLAX_PER_CYCLE,
        ("spinning_retting_house", "water") => SPINNING_RETTING_FLAX_WATER_PER_CYCLE,
...
mod tests {
    ...
    fn grain_processors_stage_inputs_from_their_stock_policy() {
        ...
        assert_eq!(
            grain_input_runway_cycles("pastoral_farmstead", 2.0, 1.0),
            2.0
        );
