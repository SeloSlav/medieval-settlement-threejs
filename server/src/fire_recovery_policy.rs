...
mod tests {
    ...
    fn light_damage_has_a_small_but_real_repair_cost() {
        let cost = fire_recovery_cost(40.0, 20.0, 0.05, false, 1.0);
    ...
    fn a_ruin_reuses_foundations_instead_of_charging_full_price() {
        let cost = fire_recovery_cost(50.0, 30.0, 1.0, true, 1.0);
    ...
    fn carpenter_support_reduces_only_reconstruction_timber() {
        let ordinary = fire_recovery_cost(50.0, 30.0, 1.0, true, 1.0);
        let supported = fire_recovery_cost(50.0, 30.0, 1.0, true, 0.9);
