...
pub use crate::tables::{
    ...
    fire_incident, foraging_node, livestock_herd, market_state, pasture, player_resources, quarry,
    residence, residence_need, road_network_state, sim_pacing_state, tree_entity, world_config,
};
