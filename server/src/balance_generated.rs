...
pub fn marketplace_trade_contract_code(id: &str) -> Option<u8> {
    match id {
        ...
        "sell_roof_tiles" => Some(45),
        "sell_meat" => Some(46),
        "sell_fish" => Some(47),
        "sell_berries" => Some(48),
        "sell_mushrooms" => Some(49),
        "sell_milk" => Some(50),
        "sell_apples" => Some(51),
        "sell_pears" => Some(52),
        "sell_cherries" => Some(53),
        "sell_aronia" => Some(54),
        "sell_rosehips" => Some(55),
        "sell_cabbage" => Some(56),
        "sell_carrots" => Some(57),
        "sell_beetroot" => Some(58),
        "sell_eggs" => Some(59),
        "sell_grapes" => Some(60),
