...
const SALVAGE_PILE: BuildingDef = BuildingDef {
    ...
    storage_wool: 2000.0,
    storage_yarn: 2000.0,
    storage_linen: 2000.0,
    storage_cloth: 2000.0,
    storage_pelts: 2000.0,
...
const ALL: &[BuildingDef] = &[FOUNDERS_CAMP, SALVAGE_PILE, LUMBER_MILL, REFORESTER, WOODCUTTERS_LODGE, STONE_QUARRY, LARGE_QUARRY, MINE, CLAY_PIT, CHARCOAL_BURNER, SMITHY, POTTER_KILN, WELL, HUNTERS_HALL, FORAGERS_SHED, FISHING_CAMP, CHAPEL, WAYSIDE_SHRINE, MARKETPLACE, TRADING_POST, TOWN_HALL, STABLE, VILLAGE_STOREHOUSE, WATCHTOWER, GUARDHOUSE, PALISADED_REFUGE, THRESHING_BARN, PASTORAL_FARMSTEAD, SWINEHERD, MONASTERY, BREWERY, TAVERN, SMOKEHOUSE, GRANARY, BAKERY, APIARY, WATERMILL, WINDMILL, CARPENTER, SPINNING_RETTING_HOUSE, WEAVER, TANNERY, COBBLER, CHANDLERY];
...
const ALL_BACKYARD_GARDENS: &[BackyardGardenDef] = &[BACKYARD_ORCHARD, BACKYARD_APPLE_ORCHARD, BACKYARD_CHERRY_ORCHARD, BACKYARD_PEAR_ORCHARD, BACKYARD_ARONIA_ORCHARD, BACKYARD_ROSEHIP_ORCHARD, BACKYARD_VEGETABLE_GARDEN, BACKYARD_CABBAGE_GARDEN, BACKYARD_CARROT_GARDEN, BACKYARD_BEETROOT_GARDEN, BACKYARD_FLOWER_GARDEN, BACKYARD_HERB_GARDEN, BACKYARD_ANIMAL_PEN, BACKYARD_CHICKEN_PEN, BACKYARD_GOAT_PEN, BACKYARD_PIG_PEN, BACKYARD_BACKYARD_APIARY];
...
pub fn marketplace_trade_contract_code(id: &str) -> Option<u8> {
    match id {
        ...
        "sell_cabbage" => Some(50),
        "sell_carrots" => Some(51),
        "sell_beetroot" => Some(52),
        "sell_eggs" => Some(53),
        "sell_grapes" => Some(54),
        "sell_cured_meat" => Some(55),
        "sell_smoked_fish" => Some(56),
        "sell_cheese" => Some(57),
        "sell_aronia_jam" => Some(58),
        "sell_rosehip_jam" => Some(59),
        "sell_rye_sheaves" => Some(60),
        "sell_oat_sheaves" => Some(61),
        "sell_barley_sheaves" => Some(62),
        "sell_maslin_sheaves" => Some(63),
        "sell_cider" => Some(64),
        "sell_pear_cider" => Some(65),
        "sell_yarn" => Some(66),
        "sell_linen" => Some(67),
        "sell_pelts" => Some(68),
        _ => None,
...
pub fn marketplace_trade_offer_for_contract_code(code: u8) -> Option<&'static MarketplaceTradeOffer> {
    let id = match code {
        ...
        60 => "sell_rye_sheaves",
        61 => "sell_oat_sheaves",
        62 => "sell_barley_sheaves",
        63 => "sell_maslin_sheaves",
        64 => "sell_cider",
        65 => "sell_pear_cider",
        66 => "sell_yarn",
        67 => "sell_linen",
