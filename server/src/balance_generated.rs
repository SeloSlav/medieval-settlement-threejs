...
pub const RESIDENCE_SERVICE_MAX_PENALTY_DAYS: f64 = 18.0;
pub const RESIDENCE_SERVICE_MIN_ECONOMIC_MULTIPLIER: f64 = 0.55;
...
pub const MONASTERY_OAT_GRAIN_PER_CYCLE: f64 = 2.0;
...
pub fn marketplace_trade_contract_code(id: &str) -> Option<u8> {
    match id {
        ...
        "sell_eggs" => Some(43),
        "sell_grapes" => Some(44),
        "sell_porridge" => Some(45),
        "sell_cured_meat" => Some(46),
        "sell_smoked_fish" => Some(47),
        "sell_cheese" => Some(48),
        "sell_rye_sheaves" => Some(49),
        "sell_oat_sheaves" => Some(50),
        "sell_barley_sheaves" => Some(51),
        "sell_maslin_sheaves" => Some(52),
        _ => None,
    }
}
...
pub fn marketplace_trade_offer_for_contract_code(code: u8) -> Option<&'static MarketplaceTradeOffer> {
    let id = match code {
        ...
        49 => "sell_rye_sheaves",
        50 => "sell_oat_sheaves",
        51 => "sell_barley_sheaves",
        52 => "sell_maslin_sheaves",
        _ => return None,
    };
