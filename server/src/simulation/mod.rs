...
mod military;
pub use military::build_owner_combat_navigation;
...
pub use delivery_trips::{
    ...
    preserve_in_transit_cart_labor, serialize_route_polyline, staffed_cart_workers_by_building, step_delivery_trips,
...
pub use military::{capture_combat_motion_frame, step_military_world};
pub(crate) use oxen::{
