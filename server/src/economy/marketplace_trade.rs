...
fn trade_commodity(resource: TradeResource) -> CommodityKind {
    match resource {
        ...
        TradeResource::Food => CommodityKind::RyeBread,
        TradeResource::Grain => CommodityKind::RyeGrain,
        TradeResource::Flour => CommodityKind::RyeFlour,
...
fn treasury_trade_stock(
    ...
    match resource {
        ...
        TradeResource::Food => row.rye_bread,
        TradeResource::Grain => row.rye_grain,
        TradeResource::Flour => row.rye_flour,
...
fn withdraw_treasury_trade_stock(
    ...
    match resource {
        ...
        TradeResource::Food => treasury.rye_bread -= amount,
        TradeResource::Grain => treasury.rye_grain -= amount,
        TradeResource::Flour => treasury.rye_flour -= amount,
