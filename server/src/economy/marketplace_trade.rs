...
fn trade_resource_name(resource: TradeResource) -> &'static str {
    match resource {
        ...
        TradeResource::RyeSheaves => "rye sheaves",
        TradeResource::OatSheaves => "oat sheaves",
...
fn treasury_trade_stock(
    ...
    match resource {
        ...
        TradeResource::RyeSheaves => row.rye_sheaves,
        TradeResource::OatSheaves => row.oat_sheaves,
        TradeResource::BarleySheaves => row.barley_sheaves,
        TradeResource::MaslinSheaves => row.maslin_sheaves,
...
fn withdraw_treasury_trade_stock(
    ...
    match resource {
        ...
        TradeResource::RyeSheaves => treasury.rye_sheaves -= amount,
        TradeResource::OatSheaves => treasury.oat_sheaves -= amount,
        TradeResource::BarleySheaves => treasury.barley_sheaves -= amount,
        TradeResource::MaslinSheaves => treasury.maslin_sheaves -= amount,
