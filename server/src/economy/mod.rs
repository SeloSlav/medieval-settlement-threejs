...
pub use commodities::{
    ...
    food_category, food_category_qualifying_stock, household_food_per_day,
    residence_edible_food_stock, residence_food_category_mask, residence_food_category_stock,
