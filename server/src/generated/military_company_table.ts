...
export default __t.row({
  ...
  state: __t.u8(),
  departureRequested: __t.bool().name("departure_requested"),
  formation: __t.u8(),
  formationColumns: __t.u32().name("formation_columns"),
  running: __t.bool(),
  fireAtWill: __t.bool().name("fire_at_will"),
  stance: __t.u8(),
  facingX: __t.f64().name("facing_x"),
  facingZ: __t.f64().name("facing_z"),
