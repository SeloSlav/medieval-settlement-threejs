...
| --- | --- | --- | --- |
| Open meadow groundcover v3 | High | Consider after an in-game scale test | `rts-groundcover-meadow-v3` |
| Dense shaded groundcover v2 | High | Consider after an in-game scale test | `rts-groundcover-dense-v2` |
| Dry late-summer groundcover v4 | High | Consider after an in-game scale test | `rts-groundcover-dry-v4` |
...
| close meadow grass and forest-floor ivy | Live alpha-cut foliage geometry; ivy uses a dedicated v2 atlas across 160 individually rooted instanced leaves per patch | Keep outside PATINA Material. Ivy leaves follow terrain-hugging runner roots and all respond to SeedThree hinge wind, with no colony carrier sheets or detached moving overlay. |
