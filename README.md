...
- `npm run test:fishing` validates fish world placement, dry-land camp placement, storage, residence food claims, icon treatment, finite population harvesting, spring reproduction, winter freeze, and extinction.
